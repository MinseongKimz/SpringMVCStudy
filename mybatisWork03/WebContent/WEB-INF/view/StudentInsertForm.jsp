...
<div>
	<h1>성적관리(Spring MVC + Annotation + mybatis 버전)</h1>
</div>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="active">
					<a href="studentlist.action">학생관리 <span class="sr-only">(current)</span></a>				
				</li>
				<li>
	...
	<div class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading row">
				...
				<span class="col-md-9">
					<a href="studentlist.action" role="botton"
					class="btn btn-success btn-xs" id="btnAdd"
					style="vertical-align: bottom;">리스트 출력</a>
				</span>
			</div>
