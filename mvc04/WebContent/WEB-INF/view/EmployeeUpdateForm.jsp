...
<script type="text/javascript">
	...
	function ajaxRequest()
	{
		...
		//※ 참고로.. data는 파라미터 데이터타입을 그대로 취하게 되므로
		//	 html 이든 .. 문자열이든.. 상관없다.
      ...
      <form action="employeeupdate.action" method="post" id="employeeForm">
         ...
         <tr>
            ...
            <tr>
               ...
               <td>
                  <select id="regionId" name="regionId">
                    	 ...
                    	 <option value="4" selected="selected">대전</option>
               ...
               <td>
                  <select id="positionId" name="positionId">
				   ...
				   <c:forEach var="position" items="${positionList }">
                      	...
                      	"selected=\"selected\"" : "" }>${position.positionName }</option>
                    </c:forEach>
                  </select>
               </td>
            </tr>
            ...
            <tr>
            	...
            	style="width: 40%; height:30px;" >직원 변경</button>
